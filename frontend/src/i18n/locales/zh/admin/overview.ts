export default {
    ...
    dashboard: {
      ...
      activeAccounts: '活跃账号',
      accountUsage: '账号用量',
      accountUsageOpen: '查看账号用量',
      accountUsageAccounts: '{count} 个账号',
      accountUsageAttention: '{count} 个需关注',
      accountUsageHealthy: '全部正常',
      accountUsageEmpty: '暂无可用窗口',
      accountUsageFailed: '用量读取失败',
      accountUsageRefresh: '刷新上游用量',
      accountUsageNotScheduled: '已暂停调度',
      todayRequests: '今日请求',
      totalRequests: '总请求数',
      todayCost: '今日消费',
      totalCost: '总消费',
      ...
      cache: '缓存',
      recentUsage: '最近使用',
      apiKeyUsageTrend: 'Key 使用趋势',
      viewModelDistribution: '模型分布',
      viewSpendingRanking: '账号消费榜',
      viewApiKeySpendingRanking: 'Key 消费榜',
      spendingRankingTitle: '账号消费榜',
      apiKeySpendingRankingTitle: 'Key 消费榜',
      activeKeyConcurrency: '活跃 Key 并发',
      activeKeyConcurrencyHint: '当前正在处理的请求',
      totalConcurrency: '总并发',
      noActiveKeyConcurrency: '当前没有活跃 Key',
      spendingRankingAccount: '账号',
      ...
      upstreamHintUsd: 'OpenAI 账号实际计费口径：系统价 × 账号倍率，单位美元。',
      upstreamHintCny: 'DeepSeek 官方 API 按官方价重算：缓存命中、缓存未命中、输出分开计价，工作日 9:00-12:00 与 14:00-18:00 为高峰价。',
      upstreamHintGlm: 'GLM Coding Plan 积分：(输入×系数 + 缓存×系数 + 输出×系数) ÷ 10000，工作日 14:00-18:00 全额，其余时段五折。',
      upstreamHintQwen: 'Qwen Token Plan 的 Credits，按 53.5 Credits/百万 token 标定，不是官方公布的单价。',
      spendingRankingShare: '消费占比',
      ipCountShort: '{count} IP',
      ipDetailsOpen: '查看访问来源',
      ipDetailsTitle: '{key} 的访问来源',
      ipDistinctCount: '独立 IP',
      ipLocation: '归属地',
      ipFirstSeen: '首次访问',
      ipLastSeen: '最后访问',
    ...
    groups: {
      ...
      form: {
		...
		defaultReasoningEffort: '默认推理规则（未配置专属规则的模型）',
		defaultReasoningEffortHint: '未命中指定模型规则时使用。若只想限制 Sol，请保持此处为空。',
        ...
        modelReasoningEffortPolicies: '指定模型推理规则',
        modelReasoningEffortPoliciesHint: '精确匹配客户端请求的模型名，命中后覆盖上方默认规则。',
        addModelReasoningEffortPolicy: '添加模型规则',
        removeModelReasoningEffortPolicy: '删除模型规则',
        reasoningEffortPolicyModel: '模型名称',
        reasoningEffortPolicyModelPlaceholder: '例如 gpt-5.6-sol',
        reasoningEffortPolicySchedule: '生效时间',
        reasoningEffortPolicyWeekdays: '生效日期',
        reasoningEffortPolicyStartTime: '开始时间',
        reasoningEffortPolicyEndTime: '结束时间',
        reasoningEffortPolicyScheduleHint: '按服务器时区生效；不填时间表示全天，结束早于开始时跨越次日。',
        reasoningEffortPolicyScheduleInvalid: '开始和结束时间需同时填写，且不能相同。',
        reasoningEffortPolicyMonday: '周一',
        reasoningEffortPolicyTuesday: '周二',
        reasoningEffortPolicyWednesday: '周三',
        reasoningEffortPolicyThursday: '周四',
        reasoningEffortPolicyFriday: '周五',
        reasoningEffortPolicySaturday: '周六',
        reasoningEffortPolicySunday: '周日',
