export default {
    accounts: {
      ...
      inviteReset: 'Codex 邀请重置',
      inviteResetTitle: 'Codex 邀请重置',
      inviteResetSubtitle: '查询邀请资格、发送邀请并使用 reset credit',
      inviteResetRefresh: '刷新状态',
      inviteResetAvailable: '可用重置次数',
      inviteResetAvailableUnit: '次',
      inviteResetSelectedCredit: '选择重置机会',
      inviteResetSelectCredit: '请选择 credit',
      inviteResetNoCredits: '当前没有可用重置机会',
      inviteResetUseReset: '使用重置次数',
      inviteResetUsing: '正在使用...',
      inviteResetConfirmUse: "确定要给账号 '{name}' 使用一次 Codex 重置次数吗？",
      inviteResetConfirmUseAgain: '二次确认：这个操作会消耗一次可用重置次数，继续吗？',
      inviteResetRules: '资格规则',
      inviteResetRulesEmpty: '暂无规则',
      inviteResetInviteEmails: '邀请邮箱',
      inviteResetPlaceholder: "user{'@'}example.com\nfriend{'@'}example.com",
      inviteResetEmailHint: '最多 {max} 个邮箱，支持逗号、空格或换行分隔。',
      inviteResetConsent: '我确认这些邮箱需要接收 Codex 邀请邮件',
      inviteResetSendInvite: '发送邀请',
      inviteResetSending: '正在发送...',
      inviteResetCreditFallbackTitle: 'Codex reset credit',
      inviteResetCreditFallbackDescription: '可用的 Codex 重置机会',
      inviteResetEmailsRequired: '请输入至少一个邮箱',
      inviteResetEmailLimit: '一次最多邀请 {max} 个邮箱',
      inviteResetInvalidEmail: '邮箱格式不正确：{email}',
      inviteResetConsentRequired: '请先确认发送邀请',
      inviteResetLoadFailed: '加载 Codex 邀请重置状态失败',
      ...
      inviteResetConsumeSuccess: '已使用重置次数',
      inviteResetNothingToReset: '当前没有可重置内容',
      inviteResetAlreadyRedeemed: '这个 credit 已经使用过',
      inviteResetNoCredit: '没有可用 credit',
      resetStatus: '重置状态',
      statusReset: '账号状态已重置',
