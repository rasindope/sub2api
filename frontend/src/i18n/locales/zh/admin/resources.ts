export default {
    ...
    proxies: {
      ...
      ipActivity: {
        ...
        onlyIssues: '只看异常',
        thresholds: '判断门槛',
        minimumOverlap: '最小重叠（秒）',
        highSingleOverlap: '高风险单次（秒）',
        highOverlapCount: '高风险次数',
        highTotalOverlap: '高风险累计（秒）',
        thresholdDescription: '满足最小重叠才计入；高风险满足单次门槛，或同时满足次数和累计秒数。',
        thresholdSaved: '判断门槛已保存',
        thresholdLoadFailed: '加载判断门槛失败',
        thresholdSaveFailed: '保存判断门槛失败',
        activeKeys: 'Key 数',
