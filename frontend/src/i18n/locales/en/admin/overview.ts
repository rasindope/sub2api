export default {
    ...
    dashboard: {
      ...
      accountUsageOpen: 'View account usage',
      accountUsageAccounts: '{count} accounts',
      accountUsageAttention: '{count} need attention',
      accountUsageHealthy: 'All healthy',
      accountUsageEmpty: 'No usage windows',
      accountUsageFailed: 'Failed to load usage',
      accountUsageRefresh: 'Refresh upstream usage',
      accountUsageNotScheduled: 'Scheduling paused',
      users: 'Users',
      ...
      apiKeyUsageTrend: 'Key Usage Trend',
      viewModelDistribution: 'Model Distribution',
      viewSpendingRanking: 'Account Spending Ranking',
      viewApiKeySpendingRanking: 'Key Spending Ranking',
      spendingRankingTitle: 'Account Spending Ranking',
      apiKeySpendingRankingTitle: 'Key Spending Ranking',
      activeKeyConcurrency: 'Active Key Concurrency',
      activeKeyConcurrencyHint: 'Requests currently in progress',
      totalConcurrency: 'total concurrency',
      noActiveKeyConcurrency: 'No active keys',
      spendingRankingAccount: 'Account',
      spendingRankingAccountFallback: 'Account #{id}',
      ...
      upstreamShare: 'Token share',
      upstreamUnitUsd: 'USD',
      upstreamUnitCny: 'CNY',
      upstreamUnitGlm: 'points',
      upstreamUnitQwen: 'Credits',
      upstreamHintUsd: 'What the OpenAI account is actually billed: system price x account multiplier, in USD.',
      upstreamHintCny: 'Recalculated from DeepSeek official prices: cache hit, cache miss and output are priced separately; weekdays 09:00-12:00 and 14:00-18:00 are peak.',
      upstreamHintGlm: 'GLM Coding Plan points: (input x rate + cached x rate + output x rate) / 10000, full rate on weekdays 14:00-18:00 and half rate otherwise.',
      upstreamHintQwen: 'Qwen Token Plan Credits, calibrated at 53.5 Credits per million tokens rather than an official published rate.',
      spendingRankingShare: 'Spend Share',
      ipCountShort: '{count} IP',
      ipDetailsOpen: 'View access sources',
      ipDetailsTitle: 'Access sources for {key}',
      ipDistinctCount: 'Distinct IPs',
      ipLocation: 'Location',
    ...
    groups: {
      ...
      form: {
		...
		defaultReasoningEffort: 'Default reasoning policy (models without an override)',
		defaultReasoningEffortHint: 'Used when no model-specific rule matches. Leave this empty to limit only Sol.',
        ...
        modelReasoningEffortPolicies: 'Model-specific reasoning policies',
        modelReasoningEffortPoliciesHint: 'Matches the exact client-requested model and overrides the default rule above.',
        addModelReasoningEffortPolicy: 'Add model policy',
        removeModelReasoningEffortPolicy: 'Remove model policy',
        reasoningEffortPolicyModel: 'Model name',
        reasoningEffortPolicyModelPlaceholder: 'For example, gpt-5.6-sol',
        reasoningEffortPolicySchedule: 'Schedule',
        reasoningEffortPolicyWeekdays: 'Active days',
        reasoningEffortPolicyStartTime: 'Start time',
        reasoningEffortPolicyEndTime: 'End time',
        reasoningEffortPolicyScheduleHint: 'Uses the server timezone. Empty times apply all day; an earlier end time continues into the next day.',
        reasoningEffortPolicyScheduleInvalid: 'Set both start and end times, and do not make them equal.',
        reasoningEffortPolicyMonday: 'Mon',
        reasoningEffortPolicyTuesday: 'Tue',
        reasoningEffortPolicyWednesday: 'Wed',
        reasoningEffortPolicyThursday: 'Thu',
        reasoningEffortPolicyFriday: 'Fri',
        reasoningEffortPolicySaturday: 'Sat',
        reasoningEffortPolicySunday: 'Sun',
