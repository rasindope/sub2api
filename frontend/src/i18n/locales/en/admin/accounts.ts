export default {
    accounts: {
      ...
      inviteReset: 'Codex Invite Reset',
      inviteResetTitle: 'Codex Invite Reset',
      inviteResetSubtitle: 'Check eligibility, send invites, and consume reset credits',
      inviteResetRefresh: 'Refresh status',
      inviteResetAvailable: 'Available resets',
      inviteResetAvailableUnit: 'credit(s)',
      inviteResetSelectedCredit: 'Selected credit',
      inviteResetSelectCredit: 'Select a credit',
      inviteResetNoCredits: 'No available reset credits',
      inviteResetUseReset: 'Use reset credit',
      inviteResetUsing: 'Using...',
      inviteResetConfirmUse: "Use one Codex reset credit for account '{name}'?",
      inviteResetConfirmUseAgain: 'Second confirmation: this consumes one available reset credit. Continue?',
      inviteResetRules: 'Eligibility rules',
      inviteResetRulesEmpty: 'No rules returned',
      inviteResetInviteEmails: 'Invite emails',
      inviteResetPlaceholder: "user{'@'}example.com\nfriend{'@'}example.com",
      inviteResetEmailHint: 'Up to {max} emails. Commas, spaces, or new lines are supported.',
      inviteResetConsent: 'I confirm these emails should receive Codex invitations',
      inviteResetSendInvite: 'Send invite',
      inviteResetSending: 'Sending...',
      inviteResetCreditFallbackTitle: 'Codex reset credit',
      inviteResetCreditFallbackDescription: 'Available Codex reset credit',
      inviteResetEmailsRequired: 'Enter at least one email',
      inviteResetEmailLimit: 'You can invite up to {max} emails at once',
      inviteResetInvalidEmail: 'Invalid email: {email}',
      inviteResetConsentRequired: 'Confirm before sending invites',
      inviteResetLoadFailed: 'Failed to load Codex invite reset status',
      ...
      inviteResetConsumeSuccess: 'Reset credit used',
      inviteResetNothingToReset: 'Nothing to reset',
      inviteResetAlreadyRedeemed: 'This credit was already redeemed',
      inviteResetNoCredit: 'No credit available',
      resetStatus: 'Reset Status',
