export default {
    ...
    proxies: {
      ...
      ipActivity: {
        ...
        minimumOverlap: 'Minimum overlap (s)',
        highSingleOverlap: 'High-risk single (s)',
        highOverlapCount: 'High-risk count',
        highTotalOverlap: 'High-risk total (s)',
        thresholdDescription: 'Only overlaps meeting the minimum are counted. High risk requires the single-event limit, or both the count and total limits.',
        thresholdSaved: 'Thresholds saved',
        thresholdLoadFailed: 'Failed to load thresholds',
