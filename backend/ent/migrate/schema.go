...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "system_concurrency_activation_threshold", Type: field.TypeInt, Nullable: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "reasoning_effort_model_policies", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
